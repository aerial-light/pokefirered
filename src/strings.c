...
const u8 gText_WhiteHerb_4800Coins[] = _("WHITE HERB{CLEAR_TO 0x50}{SMALL}4,800 COINS");
const u8 gText_BrightPowder_6400Coins[] = _("BRIGHTPOWDER{CLEAR_TO 0x50}{SMALL}6,400 COINS");
const u8 gText_ChoiceBand_8000Coins[] = _("CHOICE BAND{CLEAR_TO 0x50}{SMALL}8,000 COINS");
